      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:py-12">
        ...
        <div className="rounded-xl border border-[#2a2a3a] bg-[#12121a] p-8 text-center max-w-lg mx-auto">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
            ...
            <button className="flex items-center justify-center gap-2 rounded-lg border border-[#2a2a3a] px-5 py-2.5 text-sm font-semibold text-[#e8e8ed] transition-colors hover:bg-[#1a1a26]">
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:py-12">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-[#e8e8ed] sm:text-4xl">My Gear Desk</h1>
          <p className="mt-2 text-[#9a9aab]">Welcome back, AimLabPro</p>
        </div>
        <button
