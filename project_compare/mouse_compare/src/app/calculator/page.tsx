...
export default function CalculatorPage() {
  ...
  const results = useMemo(() => {
    ...
    return scored;
  }, [length, width, grip, calculated, allMice]);
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:py-12">
      ...
      {miceError && (
        <p className="mb-6 rounded-lg border border-red-400/20 bg-red-400/10 px-4 py-3 text-sm text-red-400">{miceError}</p>
      )}
