...
export default function CalculatorPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:py-12">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight text-[#e8e8ed] sm:text-4xl">Find Your Mouse</h1>
        <p className="mt-2 text-[#9a9aab]">Based on your hand size and grip style.</p>
      </div>
